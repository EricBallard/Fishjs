...
export class ParticleSystem {
  ...
  _AddParticles(timeElapsed) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      this._particles.push({
        ...
        colour: new this.THREE.Color(),
        alpha: 1.0,
        life: life,
        maxLife: life,
        rotation: Math.random() * 2.0 * Math.PI,
        velocity: new this.THREE.Vector3(0, -15, 0),
      });
    }
  }
  ...
  _UpdateGeometry() {
    ...
    this._geometry.setAttribute("position", new this.THREE.Float32BufferAttribute(positions, 3));
    this._geometry.setAttribute(
      "size",
      new this.THREE.Float32BufferAttribute(sizes, 1)
    );
    this._geometry.setAttribute(
      "colour",
      new this.THREE.Float32BufferAttribute(colours, 4)
    );
    this._geometry.setAttribute(
      "angle",
      new this.THREE.Float32BufferAttribute(angles, 1)
    );
